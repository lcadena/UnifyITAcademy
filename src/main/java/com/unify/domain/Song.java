...
public class Song {
	...
	public Song(String title, String artistName, int duration, String songUrl, String imageUrl) throws InvalidParamException {
		if(title.trim().equals("")) throw new InvalidParamException();
		if(artistName.trim().equals("")) throw new InvalidParamException();
		if(duration < 0) throw new InvalidParamException();
		if(songUrl.trim().equals("")) throw new InvalidParamException();
		if(imageUrl.trim().equals("")) throw new InvalidParamException();	
		this.title=title;
